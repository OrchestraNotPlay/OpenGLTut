...
int main() {
  ...
  shaderErrCheck(&vertexShader);
  shaderErrCheck(&fragmentShader);

  // shader program init and bind vert and frag shaders
...
void shaderErrCheck(unsigned int *shader) {int success;
  char infoLog[512];
